...
function dbUpdateGammeProducts($picture)
{
    $db = dbconnect();
    ...
    $query = 'UPDATE `gamme_products` SET id=:id ,  name=:name,description=:description,picture=:picture,is_enable=:is_enable WHERE id
    = :id';
